...
from myapp.main.forms import EditProfileForm, PostForm
...
@login_required
def edit_profile():
    # the form constructor takes the original username. If it is the same
    # as before, then no need to do a db query. If it is different, a db query
    # is needed to check that the username is available.
